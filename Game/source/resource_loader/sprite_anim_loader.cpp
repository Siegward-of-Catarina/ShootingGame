...
#include <resource_loader/sprite_anim_loader.hpp>
#include <resource_manager/sprite_anim_resource.hpp>

namespace myge
{
   std::shared_ptr<SpriteAnimResource> SpriteAnimLoader::operator()( Renderer& renderer_, json& data ) const
   {
